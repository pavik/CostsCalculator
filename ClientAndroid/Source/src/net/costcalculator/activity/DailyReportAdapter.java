 ...
 *     &#064;code
 *     // create instance
 *     DailyReportAdapter adapter = new DailyReportAdapter(context);
 * 
 *     // use adapter
 *     adapter.some_method();
 * 
...
public class DailyReportAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        vh.tvDate.setText(getReportDate(report));
    ...
    private String getReportDate(ArrayList<StatisticReportItem> report)
    {
        if (report.size() > 0)
            return DataFormatService.formatDate(report.get(0).dateFrom);
        else
            return "not a date";
    }
