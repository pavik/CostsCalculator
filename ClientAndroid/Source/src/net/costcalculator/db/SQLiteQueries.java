...
{
    // table 'cost_items'
    public static final String TABLE_COST_ITEMS =
    ...
    public static final String TRIG_COST_ITEMS_AFTER_UPDATE = 
        "CREATE TRIGGER cost_items_after_update AFTER UPDATE ON cost_items " +
    ...
    public static final String INSERT_COST_ITEM =
        "INSERT INTO cost_items(ci_guid, ci_name) VALUES(?, ?)";
    
    public static final String GET_COST_ITEM = 
        "SELECT * FROM cost_items WHERE ci_guid = ?";
    
    public static final String DEL_COST_ITEM =
        "DELETE FROM cost_items WHERE ci_id = ?";
    
    public static final String INC_USE_COUNT =
        "UPDATE cost_items SET ci_use_count = ci_use_count + 1 WHERE ci_id = ?";
    
    public static final String GET_ALL_COST_ITEMS =
        "SELECT * FROM cost_items ORDER BY ci_use_count DESC";
    
    //***************************************************************
    
    // table 'versions'
    public static final String TABLE_VERSIONS =
    ...
    public static final String INSERT_VERSION =
        "INSERT INTO versions (ver_number) VALUES(?)";
    ...
    public static final String TABLE_COST_ITEM_RECORDS = 
        "CREATE TABLE cost_item_records (" +
    ...
    public static final String COST_ITEM_RECORDS_IDS = 
        "SELECT cir_id FROM cost_item_records WHERE cir_ci_guid = ? ORDER BY cir_datetime DESC";
    
    public static final String GET_COST_ITEM_RECORD_BY_ID = 
        "SELECT * FROM cost_item_records WHERE cir_id = ?";
}
